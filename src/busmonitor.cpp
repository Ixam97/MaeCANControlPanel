            ...
            case CMD_LOCO_DIR:
            {
                ...
                else if (_frame.dlc == 5)
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        ss_output << " Richtung: vorwärts";
                        break;
                    case 2:
                        ss_output << " Richtung: rückwärts";
                        break;
                    case 3:
            ...
            case CMD_CONFIG:
            {
                ...
                else 
                {
                    ...
                    if ((kanal == 0) && (paket == 0)) 
                    {
                        ...
                        ImGui::SameLine();
                        ImGui::Text(u8"Anzahl Messwerte: %d Anzahl Kanäle: %d Gerätenummer: 0x%08x", n_messwerte, n_kanaele, id);
                    }
                    else
                    {
                        char tmp_data[8];
